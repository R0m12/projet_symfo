 ...
 */
final class Version20230222194358 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON DEFAULT NULL, CHANGE password password VARCHAR(255) NOT NULL');
    }
}
