 ...
 */
class getMangasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MangasRepository' shared autowired service.
     *
     * @return \App\Repository\MangasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MangasRepository.php';

        return $container->privates['App\\Repository\\MangasRepository'] = new \App\Repository\MangasRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
